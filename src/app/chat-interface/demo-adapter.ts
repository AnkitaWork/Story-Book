import { ChatAdapter, IChatGroupAdapter, Group, Message,
  ChatParticipantStatus, ParticipantResponse, ChatParticipantType, IChatParticipant, MessageType } from 'ng-chat';
...
export class DemoAdapter extends ChatAdapter implements IChatGroupAdapter
{
    ...
    sendMessage(message: Message): void {
        setTimeout(() => {
            ...
            {
                const group = DemoAdapter.mockedParticipants.find(x => x.id == message.toId) as Group;
